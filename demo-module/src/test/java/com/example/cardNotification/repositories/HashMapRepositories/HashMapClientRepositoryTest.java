...
class HashMapClientRepositoryTest {
    ...
    @Test
    void findByFullNameContaining_IgnoreCase_ShouldReturnMatchingClients() {
    ...
    @Test
    void findByFullNameContaining_IgnoreCase_ShouldReturnSingleMatch() {
    ...
    @Test
    void findByFullNameContaining_IgnoreCase_ShouldReturnEmptyList_WhenNoMatches() {
